...
export const AKUN_BARANG_DALAM_PROSES = '1133'
export const AKUN_TENAGA_KERJA_LANGSUNG = '5102'
export const AKUN_OVERHEAD_PABRIK = '5103'
export const AKUN_LABA_PELEPASAN_ASET = '4203'
export const AKUN_RUGI_PELEPASAN_ASET = '7103'
