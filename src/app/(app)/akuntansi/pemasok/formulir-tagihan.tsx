  ...
  return (
    <form action={simpan} className="space-y-6">
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="referensiPemasok">Nomor Faktur Pemasok</Label>
          <Input
            id="referensiPemasok" name="referensiPemasok"
            defaultValue={awal.referensiPemasok} placeholder="Opsional"
          />
        </div>
      </div>
      ...
      <div>
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-sm font-medium">Baris Tagihan</h2>
          <Button
          ...
          <table className="w-full text-sm">
            <thead className="border-b bg-muted/40">
              <tr>
                ...
                <th className="px-3 py-2 text-left font-medium">Akun Debit</th>
        ...
        <dl className="mt-4 ml-auto max-w-sm space-y-1 text-sm">
          ...
          <BarisRingkas label="PPN Masukan" nilai={ringkasan.ppn} />
          <BarisRingkas label="Total Tagihan" nilai={totalTagihan} tegas />
          {ringkasan.pemotongan > 0 && (
            <>
              <BarisRingkas label="PPh Dipotong" nilai={-ringkasan.pemotongan} />
              <BarisRingkas label="Dibayar ke Pemasok" nilai={totalTagihan - ringkasan.pemotongan} tegas />
            </>
          )}
        </dl>
      </div>
